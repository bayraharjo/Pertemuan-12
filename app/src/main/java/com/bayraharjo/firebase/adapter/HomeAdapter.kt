package com.myanuarbf.firebase.adapter
...
import com.myanuarbf.firebase.databinding.UserListBinding
    ...
    Int) {
        ...
        holder.binding.cardView.setOnClickListener {
            ...
            bundle.putString("telepon",
                dataMhs[position].telepon)
            findNavController(it).navigate(R.id.action_homeFragment2_to_detailFragment, bundle)
        }
        ...
        holder.binding.btnEdit.setOnClickListener {
            ...
            bundle.putString("telepon",
                dataMhs[position].telepon)
            findNavController(it).navigate(R.id.action_homeFragment2_to_updateFragment, bundle)
        }
    }
